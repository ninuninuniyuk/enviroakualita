...
<section class="relative animated-bg overflow-hidden">
    ...
    <div class="container-custom py-24 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div data-aos="fade-right">
            ...
            <h1 class="text-4xl md:text-6xl font-bold leading-tight mb-6 text-gray-900 glow-text">
                Jejak Kegiatan &
                Dokumentasi Kami
            </h1>
...
<section class="py-20 text-center">
    <h2 class="text-3xl md:text-4xl font-bold mb-3 glow-text" data-aos="fade-up">
        Our Gallery
    </h2>
